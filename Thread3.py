...
def main():
    jsons_dir = "/home/zwk/GA_Data/2020/3"
    files=os.listdir(jsons_dir)
    save_root_dir = "/home/zwk/BF_DATA/2020-3"

    au_token = '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'
    for file in files:
