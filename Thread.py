            ...
            if "[bot]" in login_name:
                ...
                if "payload" in event.keys():
                    ...
                    if not commits_num == 1:
                        ...
                        recordIssueInfo(bug_fix_entity,pullrequest_info,au_token)
...
def main():
    jsons_dir = "/home/zwk/GA_Data/2020/1"
    files=os.listdir(jsons_dir)
    save_root_dir = "/home/zwk/BF_Data_2020"

    au_token = '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'
    for file in files:
